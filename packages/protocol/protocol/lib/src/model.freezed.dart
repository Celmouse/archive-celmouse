...
/// @nodoc
mixin _$Protocol {
  ProtocolEvent get event => throw _privateConstructorUsedError;
...
abstract class $ProtocolCopyWith<$Res> {
  ...
  @useResult
  $Res call({ProtocolEvent event, DateTime? timestamp, dynamic data});
}
...
class _$ProtocolImpl implements _Protocol {
  const _$ProtocolImpl(
      {required this.event, this.timestamp, required this.data});
  ...
  @override
  String toString() {
    return 'Protocol(event: $event, timestamp: $timestamp, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, event, timestamp, const DeepCollectionEquality().hash(data));
...
abstract class _Protocol implements Protocol {
  const factory _Protocol(
      {required final ProtocolEvent event,
      final DateTime? timestamp,
      required final dynamic data}) = _$ProtocolImpl;

  factory _Protocol.fromJson(Map<String, dynamic> json) =
      _$ProtocolImpl.fromJson;

  @override
  ProtocolEvent get event;
  @override
